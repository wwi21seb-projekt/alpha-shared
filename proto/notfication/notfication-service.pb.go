...
func (PushSubscriptionType) Descriptor() protoreflect.EnumDescriptor {
	return file_notfication_notfication_service_proto_enumTypes[0].Descriptor()
}

func (PushSubscriptionType) Type() protoreflect.EnumType {
	return &file_notfication_notfication_service_proto_enumTypes[0]
}
...
func (PushSubscriptionType) EnumDescriptor() ([]byte, []int) {
	return file_notfication_notfication_service_proto_rawDescGZIP(), []int{0}
}
...
func (NotificationType) Descriptor() protoreflect.EnumDescriptor {
	return file_notfication_notfication_service_proto_enumTypes[1].Descriptor()
}

func (NotificationType) Type() protoreflect.EnumType {
	return &file_notfication_notfication_service_proto_enumTypes[1]
}
...
func (NotificationType) EnumDescriptor() ([]byte, []int) {
	return file_notfication_notfication_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *PublicKeyResponse) Reset() {
	*x = PublicKeyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notfication_notfication_service_proto_msgTypes[0]
...
func (x *CreatePushSubscriptionRequest) Reset() {
	*x = CreatePushSubscriptionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notfication_notfication_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *CreatePushSubscriptionResponse) Reset() {
	*x = CreatePushSubscriptionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notfication_notfication_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreatePushSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_notfication_notfication_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetNotificationsResponse) Reset() {
	*x = GetNotificationsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notfication_notfication_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotificationsResponse) Descriptor() ([]byte, []int) {
	return file_notfication_notfication_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeleteNotificationRequest) Reset() {
	*x = DeleteNotificationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_notfication_notfication_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteNotificationRequest) Descriptor() ([]byte, []int) {
	return file_notfication_notfication_service_proto_rawDescGZIP(), []int{4}
}
...
var File_notfication_notfication_service_proto protoreflect.FileDescriptor

var file_notfication_notfication_service_proto_rawDesc = []byte{
	0x0a, 0x25, 0x6e, 0x6f, 0x74, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x6e, 0x6f,
	0x74, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x18, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x61,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x75, 0x73, 0x65,
	0x72, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	...
	0x4b, 0x65, 0x79, 0x22, 0xe9, 0x01, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x75,
	...
	0x74, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x32, 0x35, 0x36, 0x64, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x70, 0x32, 0x35, 0x36, 0x64, 0x68, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x75, 0x74,
	0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x42, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x50, 0x75, 0x73, 0x68, 0x53, 0x75, 0x62, 0x73, 0x63,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x26, 0x0a, 0x0e, 0x65, 0x78, 0x70, 0x69, 0x72,
	...
	0x49, 0x0a, 0x1e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x75, 0x73, 0x68, 0x53, 0x75, 0x62,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xe4, 0x01, 0x0a, 0x18, 0x47,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x55,
	0x0a, 0x10, 0x6e, 0x6f, 0x74, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65,
	...
	0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2a, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20,
	...
	0x72, 0x22, 0x44, 0x0a, 0x19, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x2a, 0x29, 0x0a, 0x14, 0x50, 0x75, 0x73, 0x68, 0x53,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xde, 0x01, 0x0a, 0x13, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x49, 0x5a, 0x47, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x3b, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x61, 0x6c, 0x70, 0x68, 0x61,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_notfication_notfication_service_proto_rawDescOnce sync.Once
	file_notfication_notfication_service_proto_rawDescData = file_notfication_notfication_service_proto_rawDesc
)

func file_notfication_notfication_service_proto_rawDescGZIP() []byte {
	file_notfication_notfication_service_proto_rawDescOnce.Do(func() {
		file_notfication_notfication_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_notfication_notfication_service_proto_rawDescData)
	})
	return file_notfication_notfication_service_proto_rawDescData
}

var file_notfication_notfication_service_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_notfication_notfication_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_notfication_notfication_service_proto_goTypes = []interface{}{
	...
	(*user.User)(nil),                      // 7: serveralpha.user.User
	(*common.Empty)(nil),                   // 8: serveralpha.common.Empty
}
var file_notfication_notfication_service_proto_depIdxs = []int32{
	...
	7, // 2: serveralpha.notification.GetNotificationsResponse.user:type_name -> serveralpha.user.User
	8, // 3: serveralpha.notification.PushService.GetPublicKey:input_type -> serveralpha.common.Empty
	...
	8, // 5: serveralpha.notification.NotificationService.GetNotifications:input_type -> serveralpha.common.Empty
	...
	2, // 7: serveralpha.notification.PushService.GetPublicKey:output_type -> serveralpha.notification.PublicKeyResponse
	4, // 8: serveralpha.notification.PushService.CreatePushSubscription:output_type -> serveralpha.notification.CreatePushSubscriptionResponse
	5, // 9: serveralpha.notification.NotificationService.GetNotifications:output_type -> serveralpha.notification.GetNotificationsResponse
	8, // 10: serveralpha.notification.NotificationService.DeleteNotification:output_type -> serveralpha.common.Empty
...
func init() { file_notfication_notfication_service_proto_init() }
func file_notfication_notfication_service_proto_init() {
	if File_notfication_notfication_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_notfication_notfication_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notfication_notfication_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notfication_notfication_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notfication_notfication_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_notfication_notfication_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_notfication_notfication_service_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   2,
		},
		GoTypes:           file_notfication_notfication_service_proto_goTypes,
		DependencyIndexes: file_notfication_notfication_service_proto_depIdxs,
		EnumInfos:         file_notfication_notfication_service_proto_enumTypes,
		MessageInfos:      file_notfication_notfication_service_proto_msgTypes,
	}.Build()
	File_notfication_notfication_service_proto = out.File
	file_notfication_notfication_service_proto_rawDesc = nil
	file_notfication_notfication_service_proto_goTypes = nil
	file_notfication_notfication_service_proto_depIdxs = nil
}
