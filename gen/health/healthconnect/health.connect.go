...
import (
	...
	context "context"
	errors "errors"
	health "github.com/wwi21seb-projekt/alpha-shared/gen/health"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthCheckProcedure = "/serveralpha.Health/Check"
	// HealthWatchProcedure is the fully-qualified name of the Health's Watch RPC.
	HealthWatchProcedure = "/serveralpha.Health/Watch"
)
...
// HealthClient is a client for the serveralpha.Health service.
...
// NewHealthClient constructs a client for the serveralpha.Health service. By default, it uses the
...
// Check calls serveralpha.Health.Check.
...
// Watch calls serveralpha.Health.Watch.
...
// HealthHandler is an implementation of the serveralpha.Health service.
...
func NewHealthHandler(svc HealthHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/serveralpha.Health/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthHandler) Check(context.Context, *connect.Request[health.HealthCheckRequest]) (*connect.Response[health.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.Health.Check is not implemented"))
}
...
func (UnimplementedHealthHandler) Watch(context.Context, *connect.Request[health.HealthCheckRequest], *connect.ServerStream[health.HealthCheckResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.Health.Watch is not implemented"))
}
