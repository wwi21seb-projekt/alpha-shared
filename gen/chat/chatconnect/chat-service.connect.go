...
import (
	...
	context "context"
	errors "errors"
	chat "github.com/wwi21seb-projekt/alpha-shared/gen/chat"
...
const (
	...
	ChatServiceName = "serveralpha.chat.ChatService"
)
...
const (
	...
	ChatServiceCreateChatProcedure = "/serveralpha.chat.ChatService/CreateChat"
	// ChatServiceGetChatProcedure is the fully-qualified name of the ChatService's GetChat RPC.
	ChatServiceGetChatProcedure = "/serveralpha.chat.ChatService/GetChat"
	// ChatServiceListChatsProcedure is the fully-qualified name of the ChatService's ListChats RPC.
	ChatServiceListChatsProcedure = "/serveralpha.chat.ChatService/ListChats"
	// ChatServicePrepareChatStreamProcedure is the fully-qualified name of the ChatService's
	// PrepareChatStream RPC.
	ChatServicePrepareChatStreamProcedure = "/serveralpha.chat.ChatService/PrepareChatStream"
	// ChatServiceChatStreamProcedure is the fully-qualified name of the ChatService's ChatStream RPC.
	ChatServiceChatStreamProcedure = "/serveralpha.chat.ChatService/ChatStream"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	chatServiceServiceDescriptor                 = chat.File_chat_chat_service_proto.Services().ByName("ChatService")
...
// ChatServiceClient is a client for the serveralpha.chat.ChatService service.
...
// NewChatServiceClient constructs a client for the serveralpha.chat.ChatService service. By
...
// CreateChat calls serveralpha.chat.ChatService.CreateChat.
...
// GetChat calls serveralpha.chat.ChatService.GetChat.
...
// ListChats calls serveralpha.chat.ChatService.ListChats.
...
// PrepareChatStream calls serveralpha.chat.ChatService.PrepareChatStream.
...
// ChatStream calls serveralpha.chat.ChatService.ChatStream.
...
// ChatServiceHandler is an implementation of the serveralpha.chat.ChatService service.
...
func NewChatServiceHandler(svc ChatServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/serveralpha.chat.ChatService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedChatServiceHandler) CreateChat(context.Context, *connect.Request[chat.CreateChatRequest]) (*connect.Response[chat.CreateChatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.chat.ChatService.CreateChat is not implemented"))
}
...
func (UnimplementedChatServiceHandler) GetChat(context.Context, *connect.Request[chat.GetChatRequest]) (*connect.Response[chat.GetChatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.chat.ChatService.GetChat is not implemented"))
}
...
func (UnimplementedChatServiceHandler) ListChats(context.Context, *connect.Request[common.Empty]) (*connect.Response[chat.ListChatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.chat.ChatService.ListChats is not implemented"))
}
...
func (UnimplementedChatServiceHandler) PrepareChatStream(context.Context, *connect.Request[chat.PrepareChatStreamRequest]) (*connect.Response[common.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.chat.ChatService.PrepareChatStream is not implemented"))
}
...
func (UnimplementedChatServiceHandler) ChatStream(context.Context, *connect.BidiStream[chat.ChatMessage, chat.ChatMessage]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("serveralpha.chat.ChatService.ChatStream is not implemented"))
}
