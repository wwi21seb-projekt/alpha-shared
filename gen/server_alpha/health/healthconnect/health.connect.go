...
import (
	...
	context "context"
	errors "errors"
	health "github.com/wwi21seb-projekt/alpha-shared/gen/server_alpha/health"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthName = "server_alpha.health.Health"
)
...
const (
	...
	HealthCheckProcedure = "/server_alpha.health.Health/Check"
	// HealthWatchProcedure is the fully-qualified name of the Health's Watch RPC.
	HealthWatchProcedure = "/server_alpha.health.Health/Watch"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	healthServiceDescriptor     = health.File_server_alpha_health_health_proto.Services().ByName("Health")
...
// HealthClient is a client for the server_alpha.health.Health service.
...
// NewHealthClient constructs a client for the server_alpha.health.Health service. By default, it
...
// Check calls server_alpha.health.Health.Check.
...
// Watch calls server_alpha.health.Health.Watch.
...
// HealthHandler is an implementation of the server_alpha.health.Health service.
...
func NewHealthHandler(svc HealthHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/server_alpha.health.Health/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthHandler) Check(context.Context, *connect.Request[health.HealthCheckRequest]) (*connect.Response[health.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.health.Health.Check is not implemented"))
}
...
func (UnimplementedHealthHandler) Watch(context.Context, *connect.Request[health.HealthCheckRequest], *connect.ServerStream[health.HealthCheckResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.health.Health.Watch is not implemented"))
}
