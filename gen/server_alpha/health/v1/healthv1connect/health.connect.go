...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/wwi21seb-projekt/alpha-shared/gen/server_alpha/health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "server_alpha.health.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/server_alpha.health.v1.HealthService/Check"
	// HealthServiceWatchProcedure is the fully-qualified name of the HealthService's Watch RPC.
	HealthServiceWatchProcedure = "/server_alpha.health.v1.HealthService/Watch"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	healthServiceServiceDescriptor     = v1.File_server_alpha_health_v1_health_proto.Services().ByName("HealthService")
...
// HealthServiceClient is a client for the server_alpha.health.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the server_alpha.health.v1.HealthService service.
...
// Check calls server_alpha.health.v1.HealthService.Check.
...
// Watch calls server_alpha.health.v1.HealthService.Watch.
...
// HealthServiceHandler is an implementation of the server_alpha.health.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/server_alpha.health.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.health.v1.HealthService.Check is not implemented"))
}
...
func (UnimplementedHealthServiceHandler) Watch(context.Context, *connect.Request[v1.WatchRequest], *connect.ServerStream[v1.WatchResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.health.v1.HealthService.Watch is not implemented"))
}
