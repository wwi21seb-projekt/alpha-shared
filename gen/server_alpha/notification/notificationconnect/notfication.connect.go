...
import (
	...
	notification "github.com/wwi21seb-projekt/alpha-shared/gen/server_alpha/notification"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PushServiceName = "server_alpha.notification.PushService"
	// NotificationServiceName is the fully-qualified name of the NotificationService service.
	NotificationServiceName = "server_alpha.notification.NotificationService"
)
...
const (
	...
	// RPC.
	PushServiceGetPublicKeyProcedure = "/server_alpha.notification.PushService/GetPublicKey"
	// PushServiceCreatePushSubscriptionProcedure is the fully-qualified name of the PushService's
	// CreatePushSubscription RPC.
	PushServiceCreatePushSubscriptionProcedure = "/server_alpha.notification.PushService/CreatePushSubscription"
	...
	NotificationServiceGetNotificationsProcedure = "/server_alpha.notification.NotificationService/GetNotifications"
	...
	NotificationServiceDeleteNotificationProcedure = "/server_alpha.notification.NotificationService/DeleteNotification"
	...
	NotificationServiceSendNotificationProcedure = "/server_alpha.notification.NotificationService/SendNotification"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	pushServiceServiceDescriptor                          = notification.File_server_alpha_notification_notfication_proto.Services().ByName("PushService")
	...
	notificationServiceServiceDescriptor                  = notification.File_server_alpha_notification_notfication_proto.Services().ByName("NotificationService")
...
// PushServiceClient is a client for the server_alpha.notification.PushService service.
...
// NewPushServiceClient constructs a client for the server_alpha.notification.PushService service.
...
// GetPublicKey calls server_alpha.notification.PushService.GetPublicKey.
...
// CreatePushSubscription calls server_alpha.notification.PushService.CreatePushSubscription.
...
// PushServiceHandler is an implementation of the server_alpha.notification.PushService service.
...
func NewPushServiceHandler(svc PushServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/server_alpha.notification.PushService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPushServiceHandler) GetPublicKey(context.Context, *connect.Request[common.Empty]) (*connect.Response[notification.PublicKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.notification.PushService.GetPublicKey is not implemented"))
}
...
func (UnimplementedPushServiceHandler) CreatePushSubscription(context.Context, *connect.Request[notification.CreatePushSubscriptionRequest]) (*connect.Response[notification.CreatePushSubscriptionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.notification.PushService.CreatePushSubscription is not implemented"))
}

// NotificationServiceClient is a client for the server_alpha.notification.NotificationService
// service.
...
// server_alpha.notification.NotificationService service. By default, it uses the Connect protocol
...
// GetNotifications calls server_alpha.notification.NotificationService.GetNotifications.
...
// DeleteNotification calls server_alpha.notification.NotificationService.DeleteNotification.
...
// SendNotification calls server_alpha.notification.NotificationService.SendNotification.
...
// server_alpha.notification.NotificationService service.
...
func NewNotificationServiceHandler(svc NotificationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/server_alpha.notification.NotificationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotificationServiceHandler) GetNotifications(context.Context, *connect.Request[common.Empty]) (*connect.Response[notification.GetNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.notification.NotificationService.GetNotifications is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) DeleteNotification(context.Context, *connect.Request[notification.DeleteNotificationRequest]) (*connect.Response[common.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.notification.NotificationService.DeleteNotification is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) SendNotification(context.Context, *connect.Request[notification.SendNotificationRequest]) (*connect.Response[common.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server_alpha.notification.NotificationService.SendNotification is not implemented"))
}
